...
```
*/
export function pick(url: string, keys: readonly string[], options?: ParseOptions & StringifyOptions): string;
...
```
*/
export function exclude(url: string, keys: readonly string[], options?: ParseOptions & StringifyOptions): string;
