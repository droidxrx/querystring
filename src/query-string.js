...
import decodeComponent from "./decode-uri-component.js";
import splitOnFirst from "./split-on-first.js";
import filterObject from "./filter-obj.js";
...
const pick = (input, filter, options) => {
    options = Object.assign(
        {
...
const exclude = (input, filter, options) => {
